...
export default function FilterCategory() {
  ...
  return (
    <div className="px-5 flex flex-wrap justify-center gap-2 xl:flex-row xl:justify-start">
      <button
        onClick={handleResetGenre}
        className={`ease-in-out] cursor-pointer rounded-full px-5 py-2 text-sm font-bold text-[#8C8989] transition duration-300 hover:bg-amber-500 hover:text-white ${
